...
import sys
from usfm_text_editor_gui_PS import *
...
class MyWin(QtGui.QMainWindow):
    ...
    def openFile_1(self):
        ...
        if file_name:
            ...
            QtGui.QMessageBox.information(self, "Error", 
                "Unable to open file.", QtGui.QMessageBox.Ok)  
    ...
    def saveToFile_1(self):
        ...
        if (file_name.endswith('.txt') or file_name.endswith('.SFM') or file_name.endswith('.sfm')):
            ...
            QtGui.QMessageBox.information(self, "Error", 
                "Unable to save file.", QtGui.QMessageBox.Ok)
    ...
    def findTextDialog_1(self):
        find_text, ok = QtGui.QInputDialog.getText(self, "Search Text", "Find:")
        extra_selections = []
    ...
    def chooseFont_1(self):
        ...
        font, ok = QtGui.QFontDialog.getFont(current, self, options=QtGui.QFontDialog.DontUseNativeDialog)
        if ok:

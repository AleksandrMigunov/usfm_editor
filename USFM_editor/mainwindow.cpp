    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->textEdit_Text_1->setFocus();

    hidden_files_close = false;
    ...
    m_settings = new QSettings("ufsm_editor_settings.ini", QSettings::IniFormat, this);
    readSettings();
...
void MainWindow::readSettings() {
    ...
    file_1 = m_settings->value("text_1", text_1).toString();
    file_2 = m_settings->value("text_2", text_2).toString();
    file_3 = m_settings->value("text_3", text_3).toString();
    file_4 = m_settings->value("text_4", text_4).toString();
    file_5 = m_settings->value("text_5", text_5).toString();
    file_6 = m_settings->value("text_6", text_6).toString();
    file_7 = m_settings->value("text_7", text_7).toString();
    file_8 = m_settings->value("text_8", text_8).toString();
    ...
    zoom_1 = m_settings->value("zoom_1", zoom1).toInt();
    zoom_2 = m_settings->value("zoom_2", zoom2).toInt();
    zoom_3 = m_settings->value("zoom_3", zoom3).toInt();
    zoom_4 = m_settings->value("zoom_4", zoom4).toInt();
    zoom_5 = m_settings->value("zoom_5", zoom5).toInt();
    zoom_6 = m_settings->value("zoom_6", zoom6).toInt();
    zoom_7 = m_settings->value("zoom_7", zoom7).toInt();
    zoom_8 = m_settings->value("zoom_8", zoom8).toInt();
...
void MainWindow::writeSettings() {
    ...
    m_settings->setValue("text_1", file_1);
    m_settings->setValue("text_2", file_2);
    m_settings->setValue("text_3", file_3);
    m_settings->setValue("text_4", file_4);
    m_settings->setValue("text_5", file_5);
    m_settings->setValue("text_6", file_6);
    m_settings->setValue("text_7", file_7);
    m_settings->setValue("text_8", file_8);

    m_settings->setValue("language", language);
    m_settings->setValue("files_not_loading", FilesNotLoadAuto);

    m_settings->setValue("zoom_1", zoom_1);
    m_settings->setValue("zoom_2", zoom_2);
    m_settings->setValue("zoom_3", zoom_3);
    m_settings->setValue("zoom_4", zoom_4);
    m_settings->setValue("zoom_5", zoom_5);
    m_settings->setValue("zoom_6", zoom_6);
    m_settings->setValue("zoom_7", zoom_7);
    m_settings->setValue("zoom_8", zoom_8);
...
void MainWindow::open_files_at_start() {
    if (file_1 != "") {
        ...
        if(File1.open(QFile::ReadOnly | QFile::Text))
        {
            ...
            File1.close();
            if (file_1.endsWith(".html") || file_1.endsWith(".htm")) {
    ...
    if (file_2 != "") {
        ...
        if(File2.open(QFile::ReadOnly | QFile::Text))
        {
            ...
            QString text = in.readAll();
            File2.close();
            if (file_2.endsWith(".html") || file_2.endsWith(".htm")) {
    ...
    if (file_3 != "") {
        ...
        if(File3.open(QFile::ReadOnly | QFile::Text))
        {
            ...
            QString text = in.readAll();
            File3.close();
            if (file_3.endsWith(".html") || file_3.endsWith(".htm")) {
    ...
    if (file_4 != "") {
        ...
        if(File4.open(QFile::ReadOnly | QFile::Text))
        {
            ...
            QString text = in.readAll();
            File4.close();
            if (file_4.endsWith(".html") || file_4.endsWith(".htm")) {
    ...
    if (file_5 != "") {
        ...
        if(File5.open(QFile::ReadOnly | QFile::Text))
        {
            ...
            QString text = in.readAll();
            File5.close();
            if (file_5.endsWith(".html") || file_5.endsWith(".htm")) {
    ...
    if (file_6 != "") {
        //open_text("Text_6");
        QFile File6(file_6);
        if(File6.open(QFile::ReadOnly | QFile::Text))
        {
            QTextStream in(&File6);
            in.setCodec("UTF-8");
            QString text = in.readAll();
            File6.close();
            if (file_6.endsWith(".html") || file_6.endsWith(".htm")) {
    ...
    if (file_7 != "") {
        //open_text("Text_7");
        QFile File7(file_7);
        if(File7.open(QFile::ReadOnly | QFile::Text))
        {
            QTextStream in(&File7);
            in.setCodec("UTF-8");
            QString text = in.readAll();
            File7.close();
            if (file_7.endsWith(".html") || file_7.endsWith(".htm")) {
    ...
    if (file_8 != "") {
        //open_text("Text_8");
        QFile File8(file_8);
        if(File8.open(QFile::ReadOnly | QFile::Text))
        {
            QTextStream in(&File8);
            in.setCodec("UTF-8");
            QString text = in.readAll();
            File8.close();
            if (file_8.endsWith(".html") || file_8.endsWith(".htm")) {
...
void MainWindow::on_actionShow_Text_1_triggered()
{
    ...
    if (hidden_files_close == true)
    {
        on_actionNew_Text_2_triggered();
        on_actionNew_Text_3_triggered();
        on_actionNew_Text_4_triggered();
        on_actionNew_Text_5_triggered();
        on_actionNew_Text_6_triggered();
        on_actionNew_Text_7_triggered();
        on_actionNew_Text_8_triggered();
    }
}
...
void MainWindow::on_actionClose_not_close_invisible_files_triggered()
{
    if (hidden_files_close == false)
    {
        hidden_files_close = true;
        QMessageBox::information(this, tr("Information"), tr("Hidden files will be closed when closing their windows"));
    }
    else
    {
        hidden_files_close = false;
        QMessageBox::information(this, tr("Information"), tr("Hidden files will be not closed when closing their windows"));
    }
}
